...
bool Graph::DFS_Recursive(vector<vector<double>> adjMatrix, int start, int end, vector<bool>& visited, vector<int>& path) {
    visited[start] = true;
...
vector<int> Graph::DFS(vector<vector<double>> adjMatrix, int start, int end) {
